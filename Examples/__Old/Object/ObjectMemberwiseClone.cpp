...
namespace ObjectTest {
  ...
  public:
    ...
    Up<Person> ShallowCopy() { return MemberwiseClone<Person>().As<Person>(); }

    Up<Person> DeepCopy() {
      Up<Person> other = MemberwiseClone<Person>().As<Person>();
  ...
  public:
    static void Run() {
      ...
      Up<Person> person3 = person1->DeepCopy();
