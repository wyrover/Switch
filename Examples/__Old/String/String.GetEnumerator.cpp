...
void EnumerateAndDisplay(const string& phrase) {
  ...
  Console::WriteLine("\n   Total characters:        {0:% 3d}", charCount);
  Console::WriteLine("   Alphanumeric characters: {0:% 3d}", alphanumeric);
  Console::WriteLine("   Punctuation characters:  {0:% 3d}", punctuation);
  Console::WriteLine("   Control Characters:      {0:% 3d}\n", controlChars);
}
