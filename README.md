...
target_link_libraries(HelloWorld ${Pcf_LIBRARIES})
```
...
target_link_libraries(HelloWorldGui ${Pcf_LIBRARIES})
```
...
target_link_libraries(HelloWorldTest ${Pcf_WITH_TUNIT_MAIN_LIBRARIES})
```
