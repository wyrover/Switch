  ...
  namespace System {
    ...
    namespace Drawing {
      ...
      public:
        ...
        Pen(System::Drawing::Color color) : brush(as<System::Drawing::Brush>(pcf_new<SolidBrush>(color))) { this->Create(); }

        Pen(System::Drawing::Color color, float width) : brush(as<System::Drawing::Brush>(pcf_new<SolidBrush>(color))), width(width) { this->Create(); }
      ...
      private:
        ...
        void Create();
        void Destroy();
        refptr<System::Drawing::Brush> brush  = as<System::Drawing::Brush>(pcf_new<SolidBrush>(System::Drawing::Color::Black()));
