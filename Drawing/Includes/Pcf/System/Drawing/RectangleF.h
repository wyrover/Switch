/// @file
/// @brief Contains Pcf::System::Drawing::RectangleF class.
#pragma once
  ...
  namespace System {
    ...
    namespace Drawing {
      ...
      public:
        ...
        bool Equals(const object& obj) const noexcept override {return is<RectangleF>(obj) && Equals((const RectangleF&)obj);}
