...
| AppDomainManagerInitializationOptions                                                  | enum      | ![Progress](Pictures/Progress0.png)   |                                            |
...
| ArraySegment<T>                                                                        | struct    | ![Progress](Pictures/Progress75.png)  | Code review needed                         |
...
| Attribute                                                                              | class     | ![Progress](Pictures/Progress100.png) | [[*attribute-list*]]                       |
| AttributeUsageAttribute                                                                | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| CLSCompliantAttribute                                                                  | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| ContextStaticAttribute                                                                 | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| DateTime                                                                               | struct    | ![Progress](Pictures/Progress75.png)  | Code review needed                         |
...
| Enum                                                                                   | class     | ![Progress](Pictures/Progress75.png)  | Code review needed                         |
...
| FlagsAttribute                                                                         | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| GC                                                                                     | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
| GenericEventHandler<TEventArgs>                                                        | delegate  | ![Progress](Pictures/Progress100.png) | EventHandler (Same name not permit in c++) |
...
| IComparable                                                                            | interface | ![Progress](Pictures/ProgressIna.png) | Same name not permit in c++                |
| IConvertible                                                                           | interface | ![Progress](Pictures/Progress100.png) |                                            |
| ICustomFormater                                                                        | interface | ![Progress](Pictures/Progress100.png) |                                            |
| IDisposable                                                                            | interface | ![Progress](Pictures/ProgressIna.png) | no garbage collector in c++                |
...
| LoaderOptimizationAttribute                                                            | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
| LoaderOptimizationAttribute                                                            | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
| LocalDataStoreSlot                                                                     | class     | ![Progress](Pictures/Progress0.png)   |                                            |
| MarshalByRefObject                                                                     | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| MTAThreadAttribute                                                                     | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| NonSerializedAttribute                                                                 | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| ObsoleteAttribute                                                                      | class     | ![Progress](Pictures/Progress100.png) | [[deprecated]], [[deprecated("reason")]]   |
...
| ParamArrayAttribute                                                                    | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| SerializableAttribute                                                                  | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
| Single                                                                                 | struct    | ![Progress](Pictures/Progress100.png) |                                            |
| StackOverflowException                                                                 | class     | ![Progress](Pictures/Progress100.png) |                                            |
| STAThreadAttribute                                                                     | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
| String                                                                                 | class     | ![Progress](Pictures/Progress100.png) | But UTF-8                                  |
| StringComparer                                                                         | class     | ![Progress](Pictures/Progress0.png)   |                                            |
| SystemException                                                                        | class     | ![Progress](Pictures/Progress100.png) |                                            |
| ThreadStaticAttribute                                                                  | class     | ![Progress](Pictures/ProgressIna.png) | No equivalent in c++                       |
...
| Type                                                                                   | class     | ![Progress](Pictures/Progress75.png)  | Code review needed                         |
