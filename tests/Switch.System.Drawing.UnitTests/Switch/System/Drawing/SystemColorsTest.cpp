...
namespace SwitchUnitTests {
  ...
  _add_test (SystemColors, ActiveBorder)
  _add_test (SystemColors, ActiveCaption)
  _add_test (SystemColors, ActiveCaptionText)
  _add_test (SystemColors, AppWorkspace)
  _add_test (SystemColors, Control)
  _add_test (SystemColors, ControlDark)
  _add_test (SystemColors, ControlDarkDark)
  _add_test (SystemColors, ControlLight)
  _add_test (SystemColors, ControlLightLight)
  _add_test (SystemColors, ControlText)
  _add_test (SystemColors, Desktop)
  _add_test (SystemColors, GrayText)
  _add_test (SystemColors, Highlight)
  _add_test (SystemColors, HighlightText)
  _add_test (SystemColors, HotTrack)
  _add_test (SystemColors, InactiveBorder)
  _add_test (SystemColors, InactiveCaption)
  _add_test (SystemColors, InactiveCaptionText)
  _add_test (SystemColors, Info)
  _add_test (SystemColors, InfoText)
  _add_test (SystemColors, Menu)
  _add_test (SystemColors, MenuText)
  _add_test (SystemColors, ScrollBar)
  _add_test (SystemColors, Window)
  _add_test (SystemColors, WindowFrame)
  _add_test (SystemColors, WindowText)
  _add_test (SystemColors, ButtonFace)
  _add_test (SystemColors, ButtonHighlight)
  _add_test (SystemColors, ButtonShadow)
  _add_test (SystemColors, GradientActiveCaption)
  _add_test (SystemColors, GradientInactiveCaption)
  _add_test (SystemColors, MenuBar)
  _add_test (SystemColors, MenuHighlight)
}
