...
namespace SwitchUnitTests {
  ...
  _add_test (Color, Ctor)
  _add_test (Color, FromKnownColor)
  _add_test (Color, FromArgb)
  _add_test (Color, FromName)
  _add_test (Color, Transparent)
  _add_test (Color, AliceBlue)
  _add_test (Color, AntiqueWhite)
  _add_test (Color, Aqua)
  _add_test (Color, Aquamarine)
  _add_test (Color, Azure)
  _add_test (Color, Beige)
  _add_test (Color, Bisque)
  _add_test (Color, Black)
  _add_test (Color, BlanchedAlmond)
  _add_test (Color, Blue)
  _add_test (Color, BlueViolet)
  _add_test (Color, Brown)
  _add_test (Color, BurlyWood)
  _add_test (Color, CadetBlue)
  _add_test (Color, Chartreuse)
  _add_test (Color, Chocolate)
  _add_test (Color, Coral)
  _add_test (Color, CornflowerBlue)
  _add_test (Color, Cornsilk)
  _add_test (Color, Crimson)
  _add_test (Color, Cyan)
  _add_test (Color, DarkBlue)
  _add_test (Color, DarkCyan)
  _add_test (Color, DarkGoldenrod)
  _add_test (Color, DarkGray)
  _add_test (Color, DarkGreen)
  _add_test (Color, DarkKhaki)
  _add_test (Color, DarkMagenta)
  _add_test (Color, DarkOliveGreen)
  _add_test (Color, DarkOrange)
  _add_test (Color, DarkOrchid)
  _add_test (Color, DarkRed)
  _add_test (Color, DarkSalmon)
  _add_test (Color, DarkSeaGreen)
  _add_test (Color, DarkSlateBlue)
  _add_test (Color, DarkSlateGray)
  _add_test (Color, DarkTurquoise)
  _add_test (Color, DarkViolet)
  _add_test (Color, DeepPink)
  _add_test (Color, DeepSkyBlue)
  _add_test (Color, DimGray)
  _add_test (Color, DodgerBlue)
  _add_test (Color, Firebrick)
  _add_test (Color, FloralWhite)
  _add_test (Color, ForestGreen)
  _add_test (Color, Fuchsia)
  _add_test (Color, Gainsboro)
  _add_test (Color, GhostWhite)
  _add_test (Color, Gold)
  _add_test (Color, Goldenrod)
  _add_test (Color, Gray)
  _add_test (Color, Green)
  _add_test (Color, GreenYellow)
  _add_test (Color, Honeydew)
  _add_test (Color, HotPink)
  _add_test (Color, IndianRed)
  _add_test (Color, Indigo)
  _add_test (Color, Ivory)
  _add_test (Color, Khaki)
  _add_test (Color, Lavender)
  _add_test (Color, LavenderBlush)
  _add_test (Color, LawnGreen)
  _add_test (Color, LemonChiffon)
  _add_test (Color, LightBlue)
  _add_test (Color, LightCoral)
  _add_test (Color, LightCyan)
  _add_test (Color, LightGoldenrodYellow)
  _add_test (Color, LightGray)
  _add_test (Color, LightGreen)
  _add_test (Color, LightPink)
  _add_test (Color, LightSalmon)
  _add_test (Color, LightSeaGreen)
  _add_test (Color, LightSkyBlue)
  _add_test (Color, LightSlateGray)
  _add_test (Color, LightSteelBlue)
  _add_test (Color, LightYellow)
  _add_test (Color, Lime)
  _add_test (Color, LimeGreen)
  _add_test (Color, Linen)
  _add_test (Color, Magenta)
  _add_test (Color, Maroon)
  _add_test (Color, MediumAquamarine)
  _add_test (Color, MediumBlue)
  _add_test (Color, MediumOrchid)
  _add_test (Color, MediumPurple)
  _add_test (Color, MediumSeaGreen)
  _add_test (Color, MediumSlateBlue)
  _add_test (Color, MediumSpringGreen)
  _add_test (Color, MediumTurquoise)
  _add_test (Color, MediumVioletRed)
  _add_test (Color, MidnightBlue)
  _add_test (Color, MintCream)
  _add_test (Color, MistyRose)
  _add_test (Color, Moccasin)
  _add_test (Color, NavajoWhite)
  _add_test (Color, Navy)
  _add_test (Color, OldLace)
  _add_test (Color, Olive)
  _add_test (Color, OliveDrab)
  _add_test (Color, Orange)
  _add_test (Color, OrangeRed)
  _add_test (Color, Orchid)
  _add_test (Color, PaleGoldenrod)
  _add_test (Color, PaleGreen)
  _add_test (Color, PaleTurquoise)
  _add_test (Color, PaleVioletRed)
  _add_test (Color, PapayaWhip)
  _add_test (Color, PeachPuff)
  _add_test (Color, Peru)
  _add_test (Color, Pink)
  _add_test (Color, Plum)
  _add_test (Color, PowderBlue)
  _add_test (Color, Purple)
  _add_test (Color, Red)
  _add_test (Color, RosyBrown)
  _add_test (Color, RoyalBlue)
  _add_test (Color, SaddleBrown)
  _add_test (Color, Salmon)
  _add_test (Color, SandyBrown)
  _add_test (Color, SeaGreen)
  _add_test (Color, SeaShell)
  _add_test (Color, Sienna)
  _add_test (Color, Silver)
  _add_test (Color, SkyBlue)
  _add_test (Color, SlateBlue)
  _add_test (Color, SlateGray)
  _add_test (Color, Snow)
  _add_test (Color, SpringGreen)
  _add_test (Color, SteelBlue)
  _add_test (Color, Tan)
  _add_test (Color, Teal)
  _add_test (Color, Thistle)
  _add_test (Color, Tomato)
  _add_test (Color, Turquoise)
  _add_test (Color, Violet)
  _add_test (Color, Wheat)
  _add_test (Color, White)
  _add_test (Color, WhiteSmoke)
  _add_test (Color, Yellow)
  _add_test (Color, YellowGreen)
}
