...
namespace {
  ...
  _add_test(LiteralOperatorConverterTest, DoubleTo_byte)
  _add_test(LiteralOperatorConverterTest, UInt64To_byte)
  _add_test(LiteralOperatorConverterTest, StringTo_byte)
  _add_test(LiteralOperatorConverterTest, CharTo_char32)
  _add_test(LiteralOperatorConverterTest, Char16To_char32)
  _add_test(LiteralOperatorConverterTest, Char32To_char32)
  _add_test(LiteralOperatorConverterTest, WCharTo_char32)
  _add_test(LiteralOperatorConverterTest, UInt64To_char32)
  _add_test(LiteralOperatorConverterTest, DoubleTo_double)
  _add_test(LiteralOperatorConverterTest, UInt64To_double)
  _add_test(LiteralOperatorConverterTest, StringTo_double)
  _add_test(LiteralOperatorConverterTest, DoubleTo_int16)
  _add_test(LiteralOperatorConverterTest, UInt64To_int16)
  _add_test(LiteralOperatorConverterTest, StringTo_int16)
  _add_test(LiteralOperatorConverterTest, DoubleTo_int32)
  _add_test(LiteralOperatorConverterTest, UInt64To_int32)
  _add_test(LiteralOperatorConverterTest, StringTo_int32)
  _add_test(LiteralOperatorConverterTest, DoubleTo_int64)
  _add_test(LiteralOperatorConverterTest, UInt64To_int64)
  _add_test(LiteralOperatorConverterTest, StringTo_int64)
  _add_test(LiteralOperatorConverterTest, DoubleTo_sbyte)
  _add_test(LiteralOperatorConverterTest, UInt64To_sbyte)
  _add_test(LiteralOperatorConverterTest, StringTo_sbyte)
  _add_test(LiteralOperatorConverterTest, DoubleTo_single)
  _add_test(LiteralOperatorConverterTest, UInt64To_single)
  _add_test(LiteralOperatorConverterTest, StringTo_single)
  _add_test(LiteralOperatorConverterTest, DoubleTo_uint16)
  _add_test(LiteralOperatorConverterTest, UInt64To_uint16)
  _add_test(LiteralOperatorConverterTest, StringTo_uint16)
  _add_test(LiteralOperatorConverterTest, DoubleTo_uint32)
  _add_test(LiteralOperatorConverterTest, UInt64To_uint32)
  _add_test(LiteralOperatorConverterTest, StringTo_uint32)
  _add_test(LiteralOperatorConverterTest, DoubleTo_uint64)
  _add_test(LiteralOperatorConverterTest, UInt64To_uint64)
  _add_test(LiteralOperatorConverterTest, StringTo_uint64)
  _add_test(LiteralOperatorConverterTest, DoubleToByte)
  _add_test(LiteralOperatorConverterTest, UInt64ToByte)
  _add_test(LiteralOperatorConverterTest, StringToByte)
  _add_test(LiteralOperatorConverterTest, CharToChar)
  _add_test(LiteralOperatorConverterTest, Char16ToChar)
  _add_test(LiteralOperatorConverterTest, Char32ToChar)
  _add_test(LiteralOperatorConverterTest, WCharToChar)
  _add_test(LiteralOperatorConverterTest, UInt64ToChar)
  _add_test(LiteralOperatorConverterTest, DoubleToDouble)
  _add_test(LiteralOperatorConverterTest, UInt64ToDouble)
  _add_test(LiteralOperatorConverterTest, StringToDouble)
  _add_test(LiteralOperatorConverterTest, CharPointerToString)
  _add_test(LiteralOperatorConverterTest, Char16PointerToString)
  _add_test(LiteralOperatorConverterTest, Char32PointerToString)
  _add_test(LiteralOperatorConverterTest, WCharPointerToString)
  _add_test(LiteralOperatorConverterTest, DoubleToInt16)
  _add_test(LiteralOperatorConverterTest, UInt64ToInt16)
  _add_test(LiteralOperatorConverterTest, StringToInt16)
  _add_test(LiteralOperatorConverterTest, DoubleToInt32)
  _add_test(LiteralOperatorConverterTest, UInt64ToInt32)
  _add_test(LiteralOperatorConverterTest, StringToInt32)
  _add_test(LiteralOperatorConverterTest, DoubleToInt64)
  _add_test(LiteralOperatorConverterTest, UInt64ToInt64)
  _add_test(LiteralOperatorConverterTest, StringToInt64)
  _add_test(LiteralOperatorConverterTest, DoubleToSByte)
  _add_test(LiteralOperatorConverterTest, UInt64ToSByte)
  _add_test(LiteralOperatorConverterTest, StringToSByte)
  _add_test(LiteralOperatorConverterTest, DoubleToSingle)
  _add_test(LiteralOperatorConverterTest, UInt64ToSingle)
  _add_test(LiteralOperatorConverterTest, StringToSingle)
  _add_test(LiteralOperatorConverterTest, DoubleToUInt16)
  _add_test(LiteralOperatorConverterTest, UInt64ToUInt16)
  _add_test(LiteralOperatorConverterTest, StringToUInt16)
  _add_test(LiteralOperatorConverterTest, DoubleToUInt32)
  _add_test(LiteralOperatorConverterTest, UInt64ToUInt32)
  _add_test(LiteralOperatorConverterTest, StringToUInt32)
  _add_test(LiteralOperatorConverterTest, DoubleToUInt64)
  _add_test(LiteralOperatorConverterTest, UInt64ToUInt64)
  _add_test(LiteralOperatorConverterTest, StringToUInt64)
}
