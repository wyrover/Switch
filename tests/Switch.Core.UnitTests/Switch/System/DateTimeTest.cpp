...
namespace {
  ...
  _add_test (DateTimeTest, MinValue)
  _add_test (DateTimeTest, MaxValue)
  _add_test (DateTimeTest, DefaultConstructor)
  _add_test (DateTimeTest, ConstructorByTicksWith0)
  _add_test (DateTimeTest, ConstructorByTicksWith0AndDateTimeKindUnspecified)
  _add_test (DateTimeTest, ConstructorByTicksWith0AndDateTimeKindLocal)
  _add_test (DateTimeTest, ConstructorByTicksWith0AndDateTimeKindUtc)
  _add_test (DateTimeTest, ConstructorByTicksWith31241376000000000LL)
  _add_test (DateTimeTest, ConstructorByTicksWith504911232000000000LL)
  //_add_ignore_test (DateTimeTest, ConstructorByTicksWith633452274520000000LLAndKindSetToLocal)
  _add_test (DateTimeTest, ConstructorByTicksWith633452274520000000LLAndKindSetToUtc)
  _add_test (DateTimeTest, ConstructorByYearMonthDayWithValue)
  _add_test (DateTimeTest, ConstructorByYearMonthDayHourMinuteSecondWithValue)
  //_add_ignore_test (DateTimeTest, ConstructorByYearMonthDayHourMinuteSecondKindWithkindToLocalAndValueWithDayligthSet)
  _add_test (DateTimeTest, ConstructorByYearMonthDayHourMinuteSecondKindWithkindToUtcAndValueWithDayligthSet)
  _add_test (DateTimeTest, ConstructorByYearMonthDayHourMinuteSecondKindWithkindToLocalAndValueWithoutDayligthSet)
  _add_test (DateTimeTest, ConstructorByYearMonthDayHourMinuteSecondKindWithkindToUtcAndValueWithoutDayligthSet)
  _add_test (DateTimeTest, Constructor)
