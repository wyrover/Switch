...
namespace SwitchUnitTests {
  ...
  _AddTest(GuidTest, CreateGuid)
  _AddTest(GuidTest, CreateGuidFromNativeByteArray)
  _AddTest(GuidTest, CreateGuidFromByteArray)
  _AddTest(GuidTest, Constructor)
  _AddTest(GuidTest, Constructor2)
  _AddTest(GuidTest, Equals)
  _AddTest(GuidTest, NewGuid)
  _AddTest(GuidTest, ToString)
  _AddTest(GuidTest, CompareTo)
  _AddTest(GuidTest, LessThanOperator)
  _AddTest(GuidTest, LessEqualOperator)
  _AddTest(GuidTest, GreateThanOperator)
  _AddTest(GuidTest, GreaterEqualOperator)
  _AddTest(GuidTest, EqualOperator)
  _AddTest(GuidTest, DifferentOperator)
}
