...
namespace SwitchUnitTests {
  ...
  _AddTest(StringTest, StringCreatedWithDefaultConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstChar16PointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstChar32PointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstWCharPointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstRawCharPointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstRawChar16PointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstRawChar32PointerConstructor)
  _AddTest(StringTest, StringCreatedWithConstRawWCharPointerConstructor)
  _AddTest(StringTest, StringCreatedWithCopyConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerNull)
  _AddTest(StringTest, StringCreatedWithConstChar16PointerNull)
  _AddTest(StringTest, StringCreatedWithConstChar32PointerNull)
  _AddTest(StringTest, StringCreatedWithConstWCharPointerNull)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndNegativeStartIndexConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndNegativeCountConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndStartIndexGreaterThenLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndCountGraterThenLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndStartIndexAndCountEqualsZeroConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndStartIndexEqualsZeroAndCountEqualLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndStartIndexAndCountInsideLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndCountInsideLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndCountEqualsLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerAndCountGreaterLengthConstructor)
  _AddTest(StringTest, StringCreatedWithConstCharPointerEmptyAndCountGreaterLengthConstructor)
  _AddTest(StringTest, StringCreatedByAssignment)
  _AddTest(StringTest, StringCreatedByAssignmentWithBackslash)
  _AddTest(StringTest, StringCreatedByAssignmentWithVerbatimBackslash)
  _AddTest(StringTest, StringCreatedByConstructorWithChars)
  _AddTest(StringTest, StringCreatedByConstructorWith32bitsChars)
  _AddTest(StringTest, CreateAStringThatConsistsOfACharacterRepeated20Times)
  _AddTest(StringTest, StringCreatedByConstructorWithPointerOnSBytes)
  _AddTest(StringTest, StringCreatedByAssignmentWithUnicodeStringLiteral)
  _AddTest(StringTest, SubscriptOperatorWithChar)
  _AddTest(StringTest, SubscriptOperatorWithChar32)
  _AddTest(StringTest, OperatorLitteralChar)
  _AddTest(StringTest, OperatorLitteralChar16)
  _AddTest(StringTest, OperatorLitteralChar32)
  _AddTest(StringTest, OperatorLitteralWChar)
  _AddTest(StringTest, OperatorAddConstCharPointer)
  _AddTest(StringTest, OperatorAddBoolean)
  _AddTest(StringTest, OperatorAddByte)
  _AddTest(StringTest, OperatorAddByteObject)
  _AddTest(StringTest, OperatorAddChar)
  _AddTest(StringTest, OperatorAddChar16)
  _AddTest(StringTest, OperatorAddChar32)
  _AddTest(StringTest, OperatorAddWChar)
  _AddTest(StringTest, OperatorAddCharObject)
  _AddTest(StringTest, OperatorAddDouble)
  _AddTest(StringTest, OperatorAddDoubleObject)
  _AddTest(StringTest, OperatorAddInt16)
  _AddTest(StringTest, OperatorAddInt16Object)
  _AddTest(StringTest, OperatorAddInt32)
  _AddTest(StringTest, OperatorAddInt32Object)
  _AddTest(StringTest, OperatorAddInt64)
  _AddTest(StringTest, OperatorAddInt64Object)
  _AddTest(StringTest, OperatorAddSByte)
  _AddTest(StringTest, OperatorAddSByteObject)
  _AddTest(StringTest, OperatorAddSingle)
  _AddTest(StringTest, OperatorAddSingleObject)
  _AddTest(StringTest, OperatorAddDateTimeObject)
  _AddTest(StringTest, CompareEmptyStrings)
  _AddTest(StringTest, CompareEmptyStringWithStringEmpty)
  _AddTest(StringTest, CompareEmptyStringWithAnyString)
  _AddTest(StringTest, CompareAnyStringWithEmptyString)
  _AddTest(StringTest, CompareSameStrings)
  _AddTest(StringTest, CompareGreaterString)
  _AddTest(StringTest, CompareLessString)
  _AddTest(StringTest, CompareIndex)
  _AddTest(StringTest, CompareEmptyStringsWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareEmptyStringWithStringEmptyWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareEmptyStringWithAnyStringWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareAnyStringWithEmptyStringWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareSameStringsWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareGreaterStringWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareLessStringWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareGreaterDifferentCaseStringWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareLessDifferentCaseStringWithIgnoreCaseTrue)
  _AddTest(StringTest, CompareEmptyStringsWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareEmptyStringWithStringEmptyWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareEmptyStringWithAnyStringWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareAnyStringWithEmptyStringWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareSameStringsWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareGreaterStringWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareLessStringWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareGreaterDifferentCaseStringWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareLessDifferentCaseStringWithIgnoreCaseFalse)
  _AddTest(StringTest, CompareIndexIgnoreCase)
  _AddTest(StringTest, Concat)
  _AddTest(StringTest, ConcatArray)
  _AddTest(StringTest, EndsWith)
  _AddTest(StringTest, EndsWithChar32)
  _AddTest(StringTest, StartsWith)
  _AddTest(StringTest, StartsWithChar32)
  _AddTest(StringTest, GetEnumeratorOnString)
  _AddTest(StringTest, ForeachOnString)
  _AddTest(StringTest, IteratorOnString)
  _AddTest(StringTest, ForOnString)
  _AddTest(StringTest, GetHashCode)
  _AddTest(StringTest, IsNullOrEmptyOnEmptyString)
  _AddTest(StringTest, IsNullOrEmptyOnNonEmptyString)
  _AddTest(StringTest, IsNullOrEmptyOnStringEmpty)
  _AddTest(StringTest, IndexOf)
  _AddTest(StringTest, IndexOfExceptions)
  _AddTest(StringTest, IndexOfAny)
  _AddTest(StringTest, IndexOfAnyExceptions)
  _AddTest(StringTest, Join)
  _AddTest(StringTest, JoinN)
  _AddTest(StringTest, JoinNExceptions)
  _AddTest(StringTest, LastIndexOf)
  _AddTest(StringTest, LastIndexOfExceptions)
  _AddTest(StringTest, LastIndexOfAny)
  _AddTest(StringTest, LastIndexOfAnyException)
  _AddTest(StringTest, PadLeft)
  _AddTest(StringTest, PadRight)
  _AddTest(StringTest, Remove)
  _AddTest(StringTest, RemoveExceptions)
  _AddTest(StringTest, Insert)
  _AddTest(StringTest, InsertExceptions)
  _AddTest(StringTest, Replace)
  _AddTest(StringTest, Split)
  _AddTest(StringTest, SplitCount)
  _AddTest(StringTest, SplitWithStringSplitOptionRemoveEmptyEntries)
  _AddTest(StringTest, SplitWithStringSplitOptioNone)
  _AddTest(StringTest, ToUpper)
  _AddTest(StringTest, ToLower)
  _AddTest(StringTest, TrimStart)
}
