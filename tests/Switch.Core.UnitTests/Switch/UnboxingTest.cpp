...
namespace SwitchUnitTests {
  ...
  _AddTest(UnboxTest, UnboxingBoolean)
  _AddTest(UnboxTest, UnboxingByte)
  _AddTest(UnboxTest, UnboxingChar)
  _AddTest(UnboxTest, UnboxingDouble)
  _AddTest(UnboxTest, UnboxingInt16)
  _AddTest(UnboxTest, UnboxingInt32)
  _AddTest(UnboxTest, UnboxingInt64)
  _AddTest(UnboxTest, UnboxingIntPtr)
  _AddTest(UnboxTest, UnboxingSByte)
  _AddTest(UnboxTest, UnboxingSingle)
  _AddTest(UnboxTest, UnboxingString)
  _AddTest(UnboxTest, UnboxingUInt16)
  _AddTest(UnboxTest, UnboxingUInt32)
  _AddTest(UnboxTest, UnboxingUInt64)
  _AddTest(UnboxTest, UnboxingUIntPtr)
  _AddTest(UnboxTest, UnboxingConstCharPointer)
  _AddTest(UnboxTest, UnboxingConstWCharPointer)
  _AddTest(UnboxTest, UnboxingConstChar16Pointer)
  _AddTest(UnboxTest, UnboxingConstChar32Pointer)
  _AddTest(UnboxTest, UnboxingAny)
  _AddTest(UnboxTest, UnboxingMyStruct)
}
