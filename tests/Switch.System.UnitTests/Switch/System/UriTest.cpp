...
namespace {
  TEST(UriTest, ConstructorWithAbsoluteUri) {
    ASSERT_NO_THROW(Uri("http://www.contoso.com"););
  }
  
  TEST(UriTest, ConstructorWithAbsoluteUriAndUriKindRelativeOrAbsoluteSpecified) {
    ASSERT_NO_THROW(Uri("http://www.contoso.com", UriKind::RelativeOrAbsolute));
  }
  
  TEST(UriTest, ConstructorWithAbsoluteUriAndUriKindAbsoluteSpecified) {
    ASSERT_NO_THROW(Uri("http://www.contoso.com", UriKind::Absolute));
  }
  
  TEST(UriTest, ConstructorWithAbsoluteUriAndUriKindRelativeSpecified) {
    ASSERT_THROW(Uri("http://www.contoso.com", UriKind::Relative), UriFormatException);
  }
  
  TEST(UriTest, ConstructorWithRelativeUri) {
    ASSERT_THROW(Uri("www.contoso.com"), UriFormatException);
  }
  
  TEST(UriTest, ConstructorWithRelativeUriAndUriKindRelativeOrAbsoluteSpecified) {
    ASSERT_NO_THROW(Uri("www.contoso.com", UriKind::RelativeOrAbsolute));
  }
  
  TEST(UriTest, ConstructorWithRelativeUriAndUriKindAbsoluteSpecified) {
    ASSERT_THROW(Uri("www.contoso.com", UriKind::Absolute), UriFormatException);
  }
  
  TEST(UriTest, ConstructorWithRelativeUriAndUriKindRelativeSpecified) {
    ASSERT_NO_THROW(Uri("www.contoso.com", UriKind::Relative));
  }
  
  TEST(UriTest, ConstructorWithInvalidUri) {
    ASSERT_THROW(Uri("://www.contoso.com"), UriFormatException);
  }
  
  TEST(UriTest, Constructor) {
  ...
  TEST(UriTest, GetOriginalString) {
  ...
  TEST(UriTest, HexUnescape) {
    int32 index = 0;
    ASSERT_EQ('<', Uri::HexUnescape("%3c", index));
    ASSERT_EQ(index, 3);
  }
  
  TEST(UriTest, IsBaseOf) {
