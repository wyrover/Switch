    ...
    namespace Windows {
      namespace FormsD {
        ...
        public:
          ...
          /// }
          /// @endcode
          ControlEventArgs(const System::Windows::FormsD::Control& control) : control(&control) {}
          ...
          /// }
          /// @endcode
          const System::Windows::FormsD::Control& Control() const { return *control; }

        private:
          const System::Windows::FormsD::Control* control;
        };
      }
    }
  }
