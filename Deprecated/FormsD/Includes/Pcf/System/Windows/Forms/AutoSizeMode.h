...
/// @cond
template<>
class EnumToStrings<System::Windows::FormsD::AutoSizeMode> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::AutoSizeMode::GrowAndShrink, "GrowAndShrink"}, {(int64)System::Windows::FormsD::AutoSizeMode::GrowOnly, "GrowOnly"}};
    flags = false;
  }
};
/// @endcond
