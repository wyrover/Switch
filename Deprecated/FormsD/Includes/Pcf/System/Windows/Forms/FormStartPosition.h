...
/// @cond
template<>
class EnumToStrings<System::Windows::FormsD::FormStartPosition> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::FormStartPosition::Manual, "Manual"}, {(int64)System::Windows::FormsD::FormStartPosition::CenterScreen, "CenterScreen"}, {(int64)System::Windows::FormsD::FormStartPosition::WindowsDefaultLocation, "WindowsDefaultLocation"}, {(int64)System::Windows::FormsD::FormStartPosition::WindowsDefaultBounds, "WindowsDefaultBounds"}, {(int64)System::Windows::FormsD::FormStartPosition::CenterParent, "CenterParent"}};
    flags = false;
  }
};
/// @endcond
