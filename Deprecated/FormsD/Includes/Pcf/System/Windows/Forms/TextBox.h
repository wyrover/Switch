/// @file
/// @brief Contains Pcf::System::Windows::Forms::TextBox class.
#pragma once
      ...
      namespace FormsD {
        ...
        public:
          ...
          Property<bool> UseSystemPasswordChar {
            pcf_get {return this->GetUseSystemPasswordChar();},
            pcf_set {this->SetUseSystemPasswordChar(value);}
          };
        ...
        private:
          ...
          bool GetUseSystemPasswordChar() const;
          void SetUseSystemPasswordChar(bool readOnly);
