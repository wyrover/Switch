...
/// @cond
template<>
class EnumToStrings<System::Windows::FormsD::MessageBoxButtons> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::MessageBoxButtons::OK, "OK"}, {(int64)System::Windows::FormsD::MessageBoxButtons::OKCancel, "OKCancel"}, {(int64)System::Windows::FormsD::MessageBoxButtons::AbortRetryIgnore, "AbortRetryIgnore"}, {(int64)System::Windows::FormsD::MessageBoxButtons::YesNoCancel, "YesNoCancel"}, {(int64)System::Windows::FormsD::MessageBoxButtons::YesNo, "YesNo"}, {(int64)System::Windows::FormsD::MessageBoxButtons::RetryCancel, "RetryCancel"}};
    flags = false;
  }
};
/// @endcond
