...
/// @cond
template<>
class EnumToStrings<System::Windows::FormsD::DialogResult> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::DialogResult::None, "None"}, {(int64)System::Windows::FormsD::DialogResult::OK, "OK"}, {(int64)System::Windows::FormsD::DialogResult::Cancel, "Cancel"}, {(int64)System::Windows::FormsD::DialogResult::Abort, "Abort"}, {(int64)System::Windows::FormsD::DialogResult::Retry, "Retry"}, {(int64)System::Windows::FormsD::DialogResult::Ignore, "Ignore"}, {(int64)System::Windows::FormsD::DialogResult::Yes, "Yes"}, {(int64)System::Windows::FormsD::DialogResult::No, "No"}};
    flags = false;
  }
};
/// @endcond
