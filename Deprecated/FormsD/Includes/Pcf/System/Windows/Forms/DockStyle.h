/// @file
/// @brief Contains Pcf::System::Windows::Forms::DockStyle enum.
#pragma once
...
/// @cond
template<>
class EnumToStrings<System::Windows::FormsD::DockStyle> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::DockStyle::None, "None"}, {(int64)System::Windows::FormsD::DockStyle::None, "None"}, {(int64)System::Windows::FormsD::DockStyle::Top, "Top"}, {(int64)System::Windows::FormsD::DockStyle::Bottom, "Bottom"}, {(int64)System::Windows::FormsD::DockStyle::Left, "Left"}, {(int64)System::Windows::FormsD::DockStyle::Right, "Right"}, {(int64)System::Windows::FormsD::DockStyle::Fill, "Fill"}};
    flags = false;
  }
};
/// @endcond
