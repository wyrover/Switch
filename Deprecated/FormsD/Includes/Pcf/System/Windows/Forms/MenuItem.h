    ...
    namespace Windows {
      ...
      namespace FormsD {
        ...
        private:
          ...
          string label;
          System::Windows::FormsD::Shortcut shortcut = System::Windows::FormsD::Shortcut::None;
        };

        class MenuItemCollection : public System::Collections::Generic::List<System::Windows::FormsD::MenuItem> {
        public:
          ...
          /// @include List.cpp
          void Add(const Pcf::System::Windows::FormsD::MenuItem& value) override {
            System::Collections::Generic::List<System::Windows::FormsD::MenuItem>::Add(value);
            MenuItemAdded(*this, value);
          }
          
          void AddRange	(const System::Collections::Generic::IEnumerable<System::Windows::FormsD::MenuItem>& enumerable) {
            for (const System::Windows::FormsD::MenuItem& item : enumerable)
              this->Add(item);
          }

          void Insert(int32 index, const Pcf::System::Windows::FormsD::MenuItem& value) override {
            Pcf::System::Collections::Generic::List<System::Windows::FormsD::MenuItem>::Insert(index, value);
            MenuItemAdded(*this, value);
          }
          ...
          bool Remove(const Pcf::System::Windows::FormsD::MenuItem& item) override {
            bool result = System::Collections::Generic::List<System::Windows::FormsD::MenuItem>::Remove(item);
          ...
          int32 RemoveAll(const Predicate<const MenuItem&>& match) {
            ...
            return System::Collections::Generic::List<System::Windows::FormsD::MenuItem>::RemoveAll(match);
          }
