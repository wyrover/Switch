...
/// @cond
template<>
class EnumToStrings<System::Windows::FormsD::VisualStyles::VisualStyleState> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::VisualStyles::VisualStyleState::NoneEnabled, "NoneEnabled"}, {(int64)System::Windows::FormsD::VisualStyles::VisualStyleState::NonClientAreaEnabled, "NonClientAreaEnabled"}, {(int64)System::Windows::FormsD::VisualStyles::VisualStyleState::ClientAreaEnabled, "ClientAreaEnabled"}, {(int64)System::Windows::FormsD::VisualStyles::VisualStyleState::ClientAndNonClientAreasEnabled, "ClientAndNonClientAreasEnabled"}};
    flags = false;
  }
};
/// @endcond
