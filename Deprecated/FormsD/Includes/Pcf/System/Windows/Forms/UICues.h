...
/// @cond
template <>
class AddFlagOperators<System::Windows::FormsD::UICues> : public TrueType {};

template<>
class EnumToStrings<System::Windows::FormsD::UICues> {
public:
  void operator ()(System::Collections::Generic::SortedDictionary<int64, string>& values, bool& flags) {
    values = {{(int64)System::Windows::FormsD::UICues::None, "None"}, {(int64)System::Windows::FormsD::UICues::ShowFocus, "ShowFocus"}, {(int64)System::Windows::FormsD::UICues::ShowKeyboard, "ShowKeyboard"}, {(int64)System::Windows::FormsD::UICues::Shown, "Shown"}, {(int64)System::Windows::FormsD::UICues::ChangeFocus, "ChangeFocus"}, {(int64)System::Windows::FormsD::UICues::ChangeKeyboard, "ChangeKeyboard"}, {(int64)System::Windows::FormsD::UICues::Changed, "Changed"}};
    flags = true;
  }
};
/// @endcond
