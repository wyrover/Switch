...
DragDropEffects Control::DoDragDrop(const Reference<object>& data, DragDropEffects allowedEffects) {
  ...
  Fl::dnd();
  System::Windows::FormsD::Control::dragDropData = data.ToPointer();
...
const System::Windows::FormsD::Cursor& Control::GetCursor() const {
  return this->cursor;
}

void Control::SetCursor(const System::Windows::FormsD::Cursor& cursor) {
...
const System::Windows::FormsD::Cursor& Control::GetDefaultCursor() const {
