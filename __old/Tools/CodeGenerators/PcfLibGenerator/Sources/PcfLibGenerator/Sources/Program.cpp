...
namespace PcfLibGenerator {
  class Program : public object {
  public:
    /// @brief
    /// The main entry point for the application
    static int Main(const Array<string>& args) {
      Console::WriteLine("Pcf Console application generator version {0}", GetVersion());
      Console::WriteLine();
    ...
    static string GetProjectIncludesPathClass1(const string& projectPath) {
    ...
    static string GetProjectSourcesPathClass1(const string& projectPath) {
...
pcf_startup (PcfLibGenerator::Program)
