/// @file
/// @brief Contains Pcf::System::Windows::Forms::ContainerControl class.
#pragma once

#include "../../ComponentModel/Component.h"
#include "../../ComponentModel/IContainer.h"
    ...
    namespace Windows {
      ...
      namespace Forms {
        ...
        public:
          ...
          virtual const System::ComponentModel::IContainer& GetContainer() const {return Reference<NullContainer>::Null();}
