...
namespace Switch {
  ...
  namespace TUnit {
    ...
    public:
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::AreEqual(24, int32(24), _current_information); // test ok
      /// TUnit::Expect::AreEqual(23, int32(24), _current_information); // test shows an error message.
      /// @endcode
      template<typename TExpected, typename TActual>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::AreEqual(24, int32(24), _current_information, "User message..."); // test ok
      /// TUnit::Expect::AreEqual(23, int32(24), _current_information, "User message..."); // test shows an error message.
      /// @endcode
      template<typename TExpected, typename TActual>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::AreNotEqual(23, int32(24), "User message...", _current_information); // test ok
      /// TUnit::Expect::AreNotEqual(24, int32(24), "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TExpected, typename TActual>
      ...
      /// int32& b = a;
      /// int32 c=  24;
      /// TUnit::Expectt::AreNotSame(c, a, "User message...", _current_information); // test ok
      /// TUnit::Expectt::AreNotSame(b, a, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TExpected, typename TActual>
      ...
      /// int32& b = a;
      /// int32 c=  24;
      /// TUnit::Expectt::AreSame(b, a, "User message...", _current_information); // test ok
      /// TUnit::Expectt::AreSame(c, a, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TExpected, typename TActual>
      ...
      /// @code
      /// Array<int> a1 = {0, 1, 2, 3};
      /// TUnit::Expectt::Contains(2, a1, _current_information); // test ok
      /// TUnit::Expectt::Contains(4, a1, _current_information); // test shows an error message.
      /// @endcode
      template<typename TItem, typename TItemCollection>
      ...
      /// @code
      /// Array<int> a1 = {0, 1, 2, 3};
      /// TUnit::Expectt::Contains(2, a1, "User message...", _current_information); // test ok
      /// TUnit::Expectt::Contains(4, a1, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TItem, typename TItemCollection>
      ...
      /// @code
      /// Array<int32> a = {1, 2 ,3, 4};
      /// Expect::DoesNotThrows(_delegate {a[2];}, _current_information); // test ok
      /// Expect::DoesNotThrows(_delegate {a[5];}, _current_information); // test shows an error message.
      /// @endcode
      ...
      /// @code
      /// Array<int32> a = {1, 2 ,3, 4};
      /// Expect::DoesNotThrows(_delegate {a[2];}, "User message...", _current_information); // test ok
      /// Expect::DoesNotThrows(_delegate {a[5];}, "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string s1 = "Anything";
      /// string s2;
      /// Expect::False(String::IsNullOrEmpty(s1), _current_information); // test ok
      /// Expect::False(String::IsNullOrEmpty(s2), _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string s1 = "Anything";
      /// string s2;
      /// Expect::False(String::IsNullOrEmpty(s1), "User message...", _current_information); // test ok
      /// Expect::False(String::IsNullOrEmpty(s2), "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::Greater(24, 12, _current_information); // test ok
      /// TUnit::Expect::Greater(24, 48, _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::Greater(24, 12, "User message...", _current_information); // test ok
      /// TUnit::Expect::Greater(24, 48, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::GreaterOrEqual(24, 12, _current_information); // test ok
      /// TUnit::Expect::GreaterOrEqual(24, 24, _current_information); // test ok
      /// TUnit::Expect::GreaterOrEqual(24, 48, _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::GreaterOrEqual(24, 12, "User message...", _current_information); // test ok
      /// TUnit::Expect::GreaterOrEqual(24, 24, "User message...", _current_information); // test ok
      /// TUnit::Expect::GreaterOrEqual(24, 48, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// string v1;
      /// string v2 = "Not empty";
      /// Expect::IsEmpty(v1, _current_information); // test ok
      /// Expect::IsEmpty(v2, _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string v1;
      /// string v2 = "Not empty";
      /// Expect::IsEmpty(v1, "User message...", _current_information); // test ok
      /// Expect::IsEmpty(v2, "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// Array<int> c1;
      /// Array<int> c2 = {0, 1, 2};
      /// Expect::IsEmpty(c1, _current_information); // test ok
      /// Expect::IsEmpty(c2, _current_information); // test shows an error message.
      /// @endcode
      template<typename TItem>
      ...
      /// Array<int> c1;
      /// Array<int> c2 = {0, 1, 2};
      /// Expect::IsEmpty(c1, "User message...", _current_information); // test ok
      /// Expect::IsEmpty(c2, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TItem>
      ...
      /// string s1 = "Anything";
      /// string s2;
      /// Expect::IsFalse(String::IsNullOrEmpty(s1), _current_information); // test ok
      /// Expect::IsFalse(String::IsNullOrEmpty(s2), _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string s1 = "Anything";
      /// string s2;
      /// Expect::IsFalse(String::IsNullOrEmpty(s1), "User message...", _current_information); // test ok
      /// Expect::IsFalse(String::IsNullOrEmpty(s2), "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// double v1 = Double::NaN;
      /// double v2 = Math::PI;
      /// Expect::IsNaN(v1, _current_information); // test ok
      /// Expect::IsNaN(v2, _current_information); // test shows an error message.
      /// @endcode
      ...
      /// double v1 = Double::NaN;
      /// double v2 = Math::PI;
      /// Expect::IsNaN(v1, "User message...", _current_information); // test ok
      /// Expect::IsNaN(v2, "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string v1 = "Not empty";
      /// string v2;
      /// Expect::IsNotEmpty(v1, _current_information); // test ok
      /// Expect::IsNotEmpty(v2, _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string v1 = "Not empty";
      /// string v2;
      /// Expect::IsNotEmpty(v1, "User message...", _current_information); // test ok
      /// Expect::IsNotEmpty(v2, "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// Array<int> c1 = {0, 1, 2};
      /// Array<int> c2;
      /// Expect::IsNotEmpty(c1, _current_information); // test ok
      /// Expect::IsNotEmpty(c2, _current_information); // test shows an error message.
      /// @endcode
      template<typename TItem>
      ...
      /// Array<int> c1 = {0, 1, 2};
      /// Array<int> c2;
      /// Expect::IsNotEmpty(c1, "User message...", _current_information); // test ok
      /// Expect::IsNotEmpty(c2, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TItem>
      ...
      /// string* s1 = &str;
      /// string* s2 = null;
      /// Expect::IsNotNull(s1, _current_information); // test ok
      /// Expect::IsNotNull(s2, _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string* s1 = &str;
      /// string* s2 = null;
      /// Expect::IsNotNull(s1, "User message..."), _current_information); // test ok
      /// Expect::IsNotNull(s2, "User message..."), _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string* s1 = null;
      /// string* s2 = &str;
      /// Expect::IsNull(s1, _current_information); // test ok
      /// Expect::IsNull(s2, _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string* s1 = null;
      /// string* s2 = &str;
      /// Expect::IsNull(s1, "User message..."), _current_information); // test ok
      /// Expect::IsNull(s2, "User message..."), _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string s1;
      /// string s2 = "Anything";
      /// Expect::IsTrue(String::IsNullOrEmpty(s1), _current_information); // test ok
      /// Expect::IsTrue(String::IsNullOrEmpty(s2), _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string s1;
      /// string s2 = "Anything";
      /// Expect::IsTrue(String::IsNullOrEmpty(s1), "User message...", _current_information); // test ok
      /// Expect::IsTrue(String::IsNullOrEmpty(s2), "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::Less(12, 24, _current_information); // test ok
      /// TUnit::Expect::Less(48, 24, _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::Less(24, 12, "User message...", _current_information); // test ok
      /// TUnit::Expect::Less(24, 48, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::LessOrEqual(12, 24, _current_information); // test ok
      /// TUnit::Expect::LessOrEqual(24, 24, _current_information); // test ok
      /// TUnit::Expect::LessOrEqual(48, 24, _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// @par Examples
      /// @code
      /// TUnit::Expect::LessOrEqual(12, 24, "User message...", _current_information); // test ok
      /// TUnit::Expect::LessOrEqual(24, 24, "User message...", _current_information); // test ok
      /// TUnit::Expect::LessOrEqual(48, 24, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename TValue1, typename TValue2>
      ...
      /// string* s1 = &str;
      /// string* s2 = null;
      /// Expect::NotNull(s1, _current_information); // test ok
      /// Expect::NotNull(s2, _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string* s1 = &str;
      /// string* s2 = null;
      /// Expect::NotNull(s1, "User message..."), _current_information); // test ok
      /// Expect::NotNull(s2, "User message..."), _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string* s1 = null;
      /// string* s2 = &str;
      /// Expect::Null(s1, _current_information); // test ok
      /// Expect::Null(s2, _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// string* s1 = null;
      /// string* s2 = &str;
      /// Expect::Null(s1, "User message..."), _current_information); // test ok
      /// Expect::Null(s2, "User message..."), _current_information); // test shows an error message.
      /// @endcode
      template<typename TPointer>
      ...
      /// @code
      /// Array<int32> a = {1, 2 ,3, 4};
      /// Expect::Throws<ArgumentOutOfRangeException>(_delegate {a[5];}, _current_information); // test ok
      /// Expect::Throws<ArgumentOutOfRangeException>(_delegate {a[2];}, _current_information); // test shows an error message.
      /// @endcode
      template<typename ExceptionType>
      ...
      /// @code
      /// Array<int32> a = {1, 2 ,3, 4};
      /// Expect::Throws<ArgumentOutOfRangeException>(_delegate {a[5];}, "User message...", _current_information); // test ok
      /// Expect::Throws<ArgumentOutOfRangeException>(_delegate {a[2];}, "User message...", _current_information); // test shows an error message.
      /// @endcode
      template<typename ExceptionType>
      ...
      /// @code
      /// Array<int32> a = {1, 2 ,3, 4};
      /// Expect::ThrowsAny(_delegate {a[5];}, _current_information); // test ok
      /// Expect::ThrowsAny(_delegate {a[2];}, _current_information); // test shows an error message.
      /// @endcode
      ...
      /// @code
      /// Array<int32> a = {1, 2 ,3, 4};
      /// Expect::ThrowsAny(_delegate {a[5];}, "User message...", _current_information); // test ok
      /// Expect::ThrowsAny(_delegate {a[2];}, "User message...", _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string s1;
      /// string s2 = "Anything";
      /// Expect::True(String::IsNullOrEmpty(s1), _current_information); // test ok
      /// Expect::True(String::IsNullOrEmpty(s2), _current_information); // test shows an error message.
      /// @endcode
      ...
      /// string s1;
      /// string s2 = "Anything";
      /// Expect::True(String::IsNullOrEmpty(s1), "User message...", _current_information); // test ok
      /// Expect::True(String::IsNullOrEmpty(s2), "User message...", _current_information); // test shows an error message.
      /// @endcode
