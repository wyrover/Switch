...
namespace Switch {
  ...
  namespace System {
    ...
    struct sw_public Byte final : public ValueType, public IComparable, public IConvertible, public IFormattable {
    public:
      ...
      template<typename T> Byte& operator-=(T value) {this->value -= value; return *this;}
      template<typename T> Byte& operator*=(T value) {this->value *= value; return *this;}
      template<typename T> Byte& operator/=(T value) {if (value.value == 0) throw DivideByZeroException(sw_current_information); this->value /= value.value; return *this;}
      template<typename T> Byte& operator%=(T value) {if (value.value == 0) throw DivideByZeroException(sw_current_information); this->value %= value.value; return *this;}
      template<typename T> Byte& operator&=(T value) {this->value &= value; return *this;}
      template<typename T> Byte& operator|=(T value) {this->value |= value; return *this;}
      template<typename T> Byte& operator^=(T value) {this->value ^= value; return *this;}
    ...
    private:
      ...
      sbyte ToSByte(const IFormatProvider& provider) const override {if (this->value > std::numeric_limits<sbyte>::max()) throw OverflowException(sw_current_information); return this->value;}
