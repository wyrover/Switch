...
namespace Switch {
  ...
  namespace System {
    ...
    namespace Diagnostics {
      ...
      class sw_public TraceEventCache : public Object {
      public:
        ...
        Property<String, ReadOnly> CallStack {
          sw_get {return Environment::StackTrace();}
        };
        ...
        Property<System::Collections::Stack, ReadOnly> LogicalOperationStack {
          sw_get {return System::Collections::Stack();}
        };
        ...
        Property<string, ReadOnly> ThreadId {
          sw_get {return string::Format("{0}", System::Threading::Thread::CurrentThread().ManagedThreadId);}
        };
        ...
        Property<int64, ReadOnly> Timestamp {
          sw_get {return Stopwatch::GetTimestamp();}
        };
