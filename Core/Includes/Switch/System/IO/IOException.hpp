  ...
  namespace System {
    ...
    namespace IO {
      ...
      public:
        ...
        /// @remarks Message is set with the default message associate to the error.
        IOException(const Caller& information) : SystemException(information) {}
        ...
        /// @param message Message string associate to the error.
        /// @param information Conatains current information of file and Number of line in the file where the exception is occurred. Typically #_caller.
        IOException(const System::String& message, const Caller& information) : SystemException(message, information) {}
        
        /// @brief Create a new instance of class IOException
        /// @param message Message string associate to the error.
        /// @param innerException The exception that is the cause of the current exception, or a null reference if no inner exception is specified.
        /// @param information Conatains current information of file and Number of line in the file where the exception is occurred. Typically #_caller.
        IOException(const System::String& message, const System::Exception& innerException, const Caller& information) : SystemException(message, innerException, information) {}
