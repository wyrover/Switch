...
namespace Switch {
  ...
  namespace System {
    ...
    class _export NullReferenceException : public SystemException {
    public:
      ...
      /// @remarks Message is set with the default message associate to the error.
      NullReferenceException(const System::Runtime::CompilerServices::Caller& information) : SystemException(information) {}
      
      /// @brief Create a new instance of class NullReferenceException
      /// @param message Message string associate to the error.
      NullReferenceException(const System::String& message) : SystemException(message) {}
