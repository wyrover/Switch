  ...
  namespace System {
    ...
    protected:
      ...
      void CopyTo(Array<T>& array, int32 index) const override {
        if (index < 0) throw System::ArgumentOutOfRangeException(pcf_current_information);
        if (index + this->Length > array.Length) throw System::ArgumentException(pcf_current_information);
        
        for (int32 i = 0; i < this->Length; i++)
          array[index+i] = (*this)[i];
      }
      void Resize(int32 newSize) {
        if (newSize < 0) throw System::ArgumentOutOfRangeException(pcf_current_information);
      ...
      void Reverse(int32 index, int32 count) {
        ...
        if (index + count > this->Count) throw ArgumentException(pcf_current_information);
    ...
    public:
      ...
      refptr<object> Clone() const override {return pcf_new<Array<T, rank, TAllocator>>(*this);}
    ...
    public:
      ...
      /// @remarks The clone is of the same Type as the original Array.
      /// @remarks This method is an O(n) operation, where n is Length.
      refptr<object> Clone() const override {return pcf_new<Array<T, 1, TAllocator>>(*this);}
    ...
    public:
      ...
      /// @remarks The clone is of the same Type as the original Array.
      /// @remarks This method is an O(n) operation, where n is Length.
      refptr<object> Clone() const override {return pcf_new<Array<T, 2, TAllocator>>(*this);}
    ...
    public:
      ...
      /// @remarks The clone is of the same Type as the original Array.
      /// @remarks This method is an O(n) operation, where n is Length.
      refptr<object> Clone() const override {return pcf_new<Array<T, 3, TAllocator>>(*this);}
