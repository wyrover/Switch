  ...
  namespace System {
    ...
    namespace Threading {
      ...
      namespace Tasks {
        ...
        template <>
        class Task<void> : public object, public ITask {
        public:
          ...
          static bool WaitAll(Array<ref<ITask>> tasks, int32 millisecondsTimeout) {
            if (millisecondsTimeout < Timeout::Infinite)
              ArgumentOutOfRangeException(_current_information);
          ...
          static Nullable<int32> __currentId__();
...
namespace Switch { namespace System { namespace Threading { namespace Tasks {
  ...
  _property<Nullable<int32>, _readonly> Task<TResult>::CurrentId {
    [] {
  ...
  template<typename TResult>
  _property<TaskFactory, _readonly> Task<TResult>::Factory {
    [] {
      return TaskFactory();
    }
  };
