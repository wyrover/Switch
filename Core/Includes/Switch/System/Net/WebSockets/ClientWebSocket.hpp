...
#include "../../Collections/Concurrent/ConcurrentQueue.hpp"
  ...
  namespace System {
    ...
    namespace Net {
      ...
      namespace WebSockets {
        ...
        class sw_public ClientWebSocket : public WebSocket {
        public:
          ...
          void Abort() override {throw NotSupportedException(sw_current_information);}
