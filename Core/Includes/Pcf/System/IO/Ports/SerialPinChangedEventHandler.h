/// @file
/// @brief Contains Pcf::System::IO::Ports::SerialPinChangedEventHandler event handler.
#pragma once
  ...
  namespace System {
    ...
    namespace IO {
      ...
      namespace Ports {
        ...
        using SerialPinChangedEventHandler = System::TEventHandler<SerialPinChangedEventArgs>;
      }
    }
  }
}
