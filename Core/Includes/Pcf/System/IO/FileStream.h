/// @file
/// @brief Contains Pcf::System::IO::FileStream class.
#pragma once
...
namespace Pcf {
  ...
  namespace System {
    ...
    namespace IO {
      ...
      class pcf_public FileStream: public Stream {
      public:
       ...
       /// @exception IOError the handle of the specified file cannot be opened
        ...
        Property<String, ReadOnly> Name {
          pcf_get {return this->data->fullPath;}
        };
      ...
      private:
        ...
        SharedPointer<FileStreamData> data = new FileStreamData();
      };
    }
  }
}
