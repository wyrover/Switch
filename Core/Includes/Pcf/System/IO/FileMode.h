/// @file
/// @brief Contains Pcf::System::IO::FileMode enum.
#pragma once
  ...
  namespace System {
    ...
    namespace IO {
      ...
      enum class FileMode {
        ...
        CreateNew = 1,
        /// @brief Specifies that the operating system should create a new file. If the file
        ...
        Create = 2,
        /// @brief Specifies that the operating system should open an existing file. The ability
        /// to open the file is dependent on the value specified by System::IO::FileAccess.
        Open = 3,
        /// @brief Specifies that the operating system should open a file if it exists; otherwise,
        ...
        OpenOrCreate = 4,
        /// @brief Specifies that the operating system should open an existing file. Once opened,
        ...
        Truncate = 5,
        /// @brief Opens the file if it exists and seeks to the end of the file, or creates
