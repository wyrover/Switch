...
namespace Pcf {
  ...
  namespace System {
    ...
    /// @include String4.cpp
    class pcf_public String final : public ValueType, public ICloneable, public IComparable, public IConvertible, public Collections::Generic::IEnumerable<char32> {
    ...
    public:
      ...
      Property<const char*, ReadOnly> Data {
       pcf_get->const char* {return this->c_str();}
      };
