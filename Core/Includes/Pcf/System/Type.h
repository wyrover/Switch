...
namespace Pcf {
  ...
  template<typename T> System::Type pcf_typeof() noexcept;
  template<typename T> System::Type pcf_typeof(const T& value) noexcept;
  /// @endcond
  ...
  namespace System {
    ...
    public:
      ...
      bool Equals(const Type& type) const noexcept;
      ...
      template<typename T>
      static TypeCode GetTypeCode(const T& value) noexcept {
      ...
      template<typename T>
      static bool IsComparable(T value) noexcept {return is<IComparable>(value);}
      
      template<typename T, class TT>
      static bool IsInstanceOfType(TT value) noexcept {return is<T>(value);}
      
      template<typename T>
      static bool IsValueType(T obj) noexcept {return is<ValueType>(obj);}
    ...
    private:
      ...
      template<typename T> friend Type Pcf::pcf_typeof() noexcept;
      template<typename T> friend Type Pcf::pcf_typeof(const T& value) noexcept;
      friend class Object;
      
      Type() noexcept;
      Type(const std::type_info& type) noexcept;
  ...
  /// @ingroup Pcf
  template<typename T>
  System::Type pcf_typeof() noexcept {
  ...
  /// @ingroup Pcf
  template<typename T>
  System::Type pcf_typeof(const T& value) noexcept {
...
#else
  template<typename T>
  System::Type typeof() noexcept {return pcf_typeof<T>();}

  template<typename T>
  System::Type typeof(const T& value) noexcept {return pcf_typeof(value);}
#endif
}
