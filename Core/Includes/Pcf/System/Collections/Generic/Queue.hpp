/// @file
/// @brief Contains Pcf::System::Collections::Generic::Queue <T> class.
#pragma once
      ...
      namespace Generic {
        ...
        public:
          ...
          virtual void CopyTo(System::Array<T>& array, int32 arrayIndex) const override {
            ...
            if (arrayIndex < 0) throw ArgumentOutOfRangeException(pcf_current_information);
            if (arrayIndex + this->Count > array.Length) throw ArgumentException(pcf_current_information);
