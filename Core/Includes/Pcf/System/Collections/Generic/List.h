/// @file
/// @brief Contains Pcf::System::Collections::Generic::List <T> class.
#pragma once
...
#include "../../../Move.h"
#include "../ObjectModel/ReadOnlyCollection.h"
#include "../../Action.h"
#include "../../Allocator.h"
      ...
      namespace Generic {
        ...
        public:
          ...
          Property<int32> Capacity {
            pcf_get {return static_cast<int32>(this->list.capacity());},
            pcf_set {
              if (value < this->Count)
          ...
          Property<const T*, ReadOnly> Data {
            pcf_get->const T* {return this->list.data();}
          };
          ...
          System::Collections::Generic::Enumerator<T> GetEnumerator() const override {
            ...
            public:
              ...
              bool MoveNext() override {
                if (this->operationNumber != this->list.operationNumber) throw System::InvalidOperationException(pcf_current_information);
            ...
            protected:
              const T& GetCurrent() const override {
                if (this->beforeFirst || this->iterator == this->list.list.end()) throw System::InvalidOperationException(pcf_current_information);
