  ...
  namespace System {
    ...
    namespace Net {
      ...
      namespace Sockets {
        ...
        class pcf_public NetworkStream : public System::IO::Stream {
        public:
          ...
          Property<System::Net::Sockets::Socket, ReadOnly> Socket {
            pcf_get {return this->data->streamSocket;}
          };
          ...
          int64 Seek(int64, System::IO::SeekOrigin) override {throw NotSupportedException(pcf_current_information);}
        ...
        protected:
          ...
          int64 GetLength() const override {throw NotImplementedException(pcf_current_information);}
          int64 GetPosition() const override {throw NotImplementedException(pcf_current_information);}
          void SetPosition(int64 position) override {throw NotImplementedException(pcf_current_information);}
