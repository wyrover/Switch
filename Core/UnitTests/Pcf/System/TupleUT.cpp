...
namespace {
  ...
  pcf_test(TupleTest, Tuple1)
  pcf_test(TupleTest, Tuple2)
  pcf_test(TupleTest, Tuple3)
  pcf_test(TupleTest, Tuple4)
  pcf_test(TupleTest, Tuple5)
  pcf_test(TupleTest, Tuple6)
  pcf_test(TupleTest, Tuple7)
  pcf_test(TupleTest, TupleRest)
  pcf_test(TupleTest, TupleRestWithTuple)
  pcf_test(TupleTest, Tuple1ToString)
  pcf_test(TupleTest, Tuple2ToString)
  pcf_test(TupleTest, Tuple3ToString)
  pcf_test(TupleTest, Tuple4ToString)
  pcf_test(TupleTest, Tuple5ToString)
  pcf_test(TupleTest, Tuple6ToString)
  pcf_test(TupleTest, Tuple7ToString)
  pcf_test(TupleTest, TupleRestToString)
  pcf_test(TupleTest, TupleRestWithTupleToString)
  pcf_test(TupleTest, CreateTuple1)
  pcf_test(TupleTest, CreateTuple2)
  pcf_test(TupleTest, CreateTuple3)
  pcf_test(TupleTest, CreateTuple4)
  pcf_test(TupleTest, CreateTuple5)
  pcf_test(TupleTest, CreateTuple6)
  pcf_test(TupleTest, CreateTuple7)
  pcf_test(TupleTest, CreateTupleRest)
  pcf_test(TupleTest, CreateTupleRestWithTuple)
  pcf_test(TupleTest, CreateTuple1AndSetItem1)
  pcf_test(TupleTest, CreateTuple2AndSetItem1)
  pcf_test(TupleTest, CreateTuple2AndSetItem2)
  pcf_test(TupleTest, CreateTuple3AndSetItem1)
  pcf_test(TupleTest, CreateTuple3AndSetItem2)
  pcf_test(TupleTest, CreateTuple3AndSetItem3)
  pcf_test(TupleTest, CreateTuple4AndSetItem1)
  pcf_test(TupleTest, CreateTuple4AndSetItem2)
  pcf_test(TupleTest, CreateTuple4AndSetItem3)
  pcf_test(TupleTest, CreateTuple4AndSetItem4)
  pcf_test(TupleTest, CreateTuple5AndSetItem1)
  pcf_test(TupleTest, CreateTuple5AndSetItem2)
  pcf_test(TupleTest, CreateTuple5AndSetItem3)
  pcf_test(TupleTest, CreateTuple5AndSetItem4)
  pcf_test(TupleTest, CreateTuple5AndSetItem5)
  pcf_test(TupleTest, CreateTuple6AndSetItem1)
  pcf_test(TupleTest, CreateTuple6AndSetItem2)
  pcf_test(TupleTest, CreateTuple6AndSetItem3)
  pcf_test(TupleTest, CreateTuple6AndSetItem4)
  pcf_test(TupleTest, CreateTuple6AndSetItem5)
  pcf_test(TupleTest, CreateTuple6AndSetItem6)
  pcf_test(TupleTest, CreateTuple7AndSetItem1)
  pcf_test(TupleTest, CreateTuple7AndSetItem2)
  pcf_test(TupleTest, CreateTuple7AndSetItem3)
  pcf_test(TupleTest, CreateTuple7AndSetItem4)
  pcf_test(TupleTest, CreateTuple7AndSetItem5)
  pcf_test(TupleTest, CreateTuple7AndSetItem6)
  pcf_test(TupleTest, CreateTuple7AndSetItem7)
  pcf_test(TupleTest, CreateTupleRestAndSetItem1)
  pcf_test(TupleTest, CreateTupleRestAndSetItem2)
  pcf_test(TupleTest, CreateTupleRestAndSetItem3)
  pcf_test(TupleTest, CreateTupleRestAndSetItem4)
  pcf_test(TupleTest, CreateTupleRestAndSetItem5)
  pcf_test(TupleTest, CreateTupleRestAndSetItem6)
  pcf_test(TupleTest, CreateTupleRestAndSetItem7)
  pcf_test(TupleTest, CreateTupleRestAndSetRest)
  pcf_test(TupleTest, CreateTuple1AndCopyItToOther)
  pcf_test(TupleTest, CreateTuple2AndCopyItToOther)
  pcf_test(TupleTest, CreateTuple3AndCopyItToOther)
  pcf_test(TupleTest, CreateTuple4AndCopyItToOther)
  pcf_test(TupleTest, CreateTuple5AndCopyItToOther)
  pcf_test(TupleTest, CreateTuple6AndCopyItToOther)
  pcf_test(TupleTest, CreateTuple7AndCopyItToOther)
  pcf_test(TupleTest, CreateTupleRestAndCopyItToOther)
  pcf_test(TupleTest, Create2SameTuple1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple1ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple2ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple2ByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple3ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple3ByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple3ByItem3AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple4ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple4ByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple4ByItem3AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple4ByItem4AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple5ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple5ByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple5ByItem3AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple5ByItem4AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple5ByItem5AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple6ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple6ByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple6ByItem3AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple6ByItem4AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple6ByItem5AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple6ByItem6AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem3AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem4AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem5AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem6AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTuple7ByItem7AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem1AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem2AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem3AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem4AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem5AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem6AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByItem7AndCheckEquals)
  pcf_test(TupleTest, Create2DifferentsTupleRestByRestAndCheckEquals)

  pcf_test(TupleTest, MyTuple)
  pcf_test(TupleTest, CreateArrayOfTuples)
  pcf_test(TupleTest, CreateListOfTuples)
  pcf_test(TupleTest, CreateDictionaryOfTuples)
