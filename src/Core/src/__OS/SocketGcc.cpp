...
int32 __OS::CoreApi::Socket::Accept(intptr handle, byte* socketAddress, int32 addressLength, intptr* socket) {
...
int32 __OS::CoreApi::Socket::Open(System::Net::Sockets::AddressFamily addressFamily, System::Net::Sockets::SocketType socketType, System::Net::Sockets::ProtocolType protocolType, intptr* socket) {
...
int32 __OS::CoreApi::Socket::Poll(intptr handle, int32 microseconds, int32 mode) {
