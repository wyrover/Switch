...
int32 Native::CoreApi::Socket::AddressFamilyToNative(System::Net::Sockets::AddressFamily addressFamily) {
#if defined(__APPLE__)
...
System::Net::Sockets::AddressFamily Native::CoreApi::Socket::NativeToAddressFamily(int32 addressFamily) {
#if defined(__APPLE__)
...
int32 Native::CoreApi::Socket::Accept(intptr handle, byte* socketAddress, int32 addressLength, intptr* socket) {
...
int32 Native::CoreApi::Socket::Bind(intptr handle, byte* socketAddress, int32 addressLength) {
  int32 result = bind(*(int32*)&handle, (struct sockaddr*)socketAddress, (socklen_t)addressLength);
  return result;
}

int32 Native::CoreApi::Socket::Close(intptr handle) {
  return close(*(int32*)&handle);
}

int32 Native::CoreApi::Socket::Connect(intptr handle, byte *socketAddress, int32 addressLength) {
  return ::connect(*(int32*)&handle, (struct sockaddr*)socketAddress, addressLength);
}

int32 Native::CoreApi::Socket::GetAvailable(intptr handle, int32* nbrBytesAvailable) {
  return ioctl(*(int32*)&handle, FIONREAD, nbrBytesAvailable);
}

int32 Native::CoreApi::Socket::GetLastError() {
  return NativeToSocketError(errno);
}

bool Native::CoreApi::Socket::GetOSSupportsIPv4() {
  return true;
}

bool Native::CoreApi::Socket::GetOSSupportsIPv6() {
  return true;
}

int32 Native::CoreApi::Socket::GetSocketOption(intptr handle, System::Net::Sockets::SocketOptionLevel socketLevel, System::Net::Sockets::SocketOptionName socketOptionName, void* option, int32* optionLength) {
...
int32 Native::CoreApi::Socket::IoCtl(intptr handle, int32 ioControl, byte* optionInValue, int32 optionInValueSize, byte* optionOutValue, int32 optionOutValueSize, int32* optionOutValueSizeReturned) {
  return -1;
}

int32 Native::CoreApi::Socket::Listen(intptr handle, int32 backLog) {
  return listen(*(int32*)&handle, backLog);
}

int32 Native::CoreApi::Socket::Open(System::Net::Sockets::AddressFamily addressFamily, System::Net::Sockets::SocketType socketType, System::Net::Sockets::ProtocolType protocolType, intptr* socket) {
...
int32 Native::CoreApi::Socket::Poll(intptr handle, int32 microseconds, int32 mode) {
...
int32 Native::CoreApi::Socket::Select(intptr* checkRead, int32 nbCheckRead, intptr* checkWrite, int32 nbCheckWrite, intptr* checkError, int32 nbCheckError, int32 microseconds) {
  int nfds = 0;
...
int32 Native::CoreApi::Socket::Receive(intptr handle,  byte *buffer, int32 bufferLength, int32 flags) {
...
int32 Native::CoreApi::Socket::ReceiveFrom(intptr handle, byte* buffer, int32 bufferLength, int32 flags, byte *socketAddress, int32 addressLength) {
...
int32 Native::CoreApi::Socket::Send(intptr handle,  byte *buffer, int32 bufferLength, int32 flags) {
  return (int32)send(*(int32*)&handle, buffer, bufferLength, flags);
}

int32 Native::CoreApi::Socket::SendTo(intptr handle, byte* buffer, int32 bufferLength, int32 flags, byte *socketAddress, int32 addressLength) {
  return (int32)sendto(*(int32*)&handle, (char*)buffer, bufferLength, flags, reinterpret_cast<sockaddr*>(socketAddress), addressLength);
}

int32 Native::CoreApi::Socket::SetBlocking(intptr handle, bool blocking) {
  int32 retValue = -1;
...
int32 Native::CoreApi::Socket::SetSocketOption(intptr handle, System::Net::Sockets::SocketOptionLevel socketLevel, System::Net::Sockets::SocketOptionName socketOptionName, void* option, int32 optionLength) {
  if (socketLevel == System::Net::Sockets::SocketOptionLevel::Socket && (socketOptionName == System::Net::Sockets::SocketOptionName::SendTimeout || socketOptionName == System::Net::Sockets::SocketOptionName::ReceiveTimeout)) {
...
int32 Native::CoreApi::Socket::Shutdown(intptr handle, int32 how) {
