...
int32 Native::CoreApi::Socket::Accept(intptr handle, byte* socketAddress, int32 addressLength, intptr* handleResult) {
...
int32 Native::CoreApi::Socket::Open(System::Net::Sockets::AddressFamily addrFamily, System::Net::Sockets::SocketType socketType, System::Net::Sockets::ProtocolType protocolType, intptr* handle) {
  if (handle == null)
    return -1;
...
int32 Native::CoreApi::Socket::Poll(intptr handle, int32 microSec, int32 mode) {
