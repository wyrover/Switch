...
namespace Switch {
  ...
  namespace System {
    ...
    class _export ArrayTypeMismatchException : public SystemException {
    public:
      ...
      /// @cond
      friend std::ostream& operator<<(std::ostream& output, const ArrayTypeMismatchException& value) {return output << value.ToString();}
      /// @endcond
