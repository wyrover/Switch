...
namespace Switch {
  ...
  namespace System {
    ...
    class export_ ArrayTypeMismatchException : public SystemException {
    public:
      ...
      /// @cond
      friend export_ std::ostream& operator<<(std::ostream& output, const ArrayTypeMismatchException& value) {return output << value.ToString();}
      /// @endcond
