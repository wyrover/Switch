...
namespace Switch {
  ...
  namespace System {
    ...
    public:
      ...
      /// @remarks Message is set with the default message associate to the error.
      ArgumentNullException(const System::Runtime::CompilerServices::Caller& information) : ArgumentException(information) {}
      ...
      /// @cond
      friend std::ostream& operator<<(std::ostream& output, const ArgumentNullException& value) {return output << value.ToString();}
      /// @endcond
