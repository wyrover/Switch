...
namespace Switch {
  ...
  namespace System {
    ...
    class export_ ArithmeticException : public SystemException {
    public:
      ...
      /// @cond
      friend export_ std::ostream& operator<<(std::ostream& output, const ArithmeticException& value) {return output << value.ToString();}
      /// @endcond
