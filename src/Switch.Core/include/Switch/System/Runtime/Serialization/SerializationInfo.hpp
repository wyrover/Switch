  ...
  namespace System {
    ...
    namespace Runtime {
      ...
      namespace Serialization {
        ...
        class export_ SerializationInfo : public Object, public System::Collections::Generic::IEnumerable<System::Collections::Generic::KeyValuePair<System::String, SerializationEntry>> {
        public:
