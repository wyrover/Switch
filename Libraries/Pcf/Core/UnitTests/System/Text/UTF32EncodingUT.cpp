...
TEST(UTF32_Encoding, Ctor) {
  ...
  SharedPointer<Text::Encoding> def = new Text::UTF32Encoding();
  SharedPointer<Text::Encoding> eFF = new Text::UTF32Encoding(false,false);
  SharedPointer<Text::Encoding> eFT = new Text::UTF32Encoding(false, true);
  SharedPointer<Text::Encoding> eTF = new Text::UTF32Encoding(true, false);
  SharedPointer<Text::Encoding> eTT = new Text::UTF32Encoding(true, true);
...
TEST(UTF32_Encoding, Encode) {
  ...
  SharedPointer<Text::UTF32Encoding> unicode = new Text::UTF32Encoding();
...
TEST(UTF32_Encoding, EncodeBigEndian) {
  // The encoding, utf32 big endian, BOM.
  SharedPointer<Text::UTF32Encoding> unicode = new Text::UTF32Encoding(true);
