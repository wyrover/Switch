...
namespace EncodingUT {
  ...
  void GetByteCountTest(SharedPointer<Encoding> encoding, int charByteSize, int piByteSize, int sigmaByteSize, int koalaByteSize) {
  ...
  void GetBytesTest(SharedPointer<Encoding> encoding, int charByteSize, int piByteSize, int sigmaByteSize, int koalaByteSize, 
