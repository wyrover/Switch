...
namespace {
  ...
  protected:
    ...
    void CreateThreadWithThreadStartStartItThenSetIsBackgroundToTrue() {
      static int32 counter;
      counter = 0;
      ThreadStart threadStart = pcf_delegate {
      };
    ...
    void CreateThreadWithParameterizedThreadStartStartItThenSetIsBackgroundToTrue() {
      static Int32 counter;
      counter = 0;
      ParameterizedThreadStart parameterizedThreadStart = pcf_delegate(const object& param) {
        Assert::AreEqual(0, as<Int32>(param), pcf_current_information);
  ...
  pcf_test(ThreadTest, CreateThreadWithThreadStartStartItThenSetIsBackgroundToTrue);
  ...
  pcf_test(ThreadTest, CreateThreadWithParameterizedThreadStartStartItThenSetIsBackgroundToTrue);
