/// @file
/// @brief Contains Pcf::System::Diagnostics::TraceEventCache class.
#pragma once
    ...
    namespace Diagnostics {
      ...
      public:
        ...
        Property<String, ReadOnly> CallStack {
          pcf_get {return Environment::StackTrace();}
        };
        ...
        Property<System::Collections::Stack, ReadOnly> LogicalOperationStack {
          pcf_get {return System::Collections::Stack();}
        };
        ...
        Property<string, ReadOnly> ThreadId {
          pcf_get {return string::Format("{0}", System::Threading::Thread::CurrentThread().ManagedThreadId);}
        };
        ...
        Property<int64, ReadOnly> Timestamp {
          pcf_get {return Stopwatch::GetTimestamp();}
        };
