/// @file
/// @brief Contains Pcf::System::ConsoleKeyInfo class.
#pragma once
...
namespace Pcf {
  ...
  namespace System {
    ...
    /// @see Console
    struct ConsoleKeyInfo : public Object, public IHashable {
    public:
      ...
      /// @return bool true if the specified object is equal to the current object. otherwise, false.
      virtual bool Equals(const object& obj) const override { return is<ConsoleKeyInfo>(obj) && Equals(static_cast<const ConsoleKeyInfo&>(obj)); }
