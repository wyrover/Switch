...
namespace Pcf {
  ...
  namespace System {
    template<typename T>
    class BoxEnum : public Object, public IComparable, public IHashable {
    public:
      BoxEnum() {}
      ...
      /// @brief Compares this instance to a specified Int32 object && returns an indication of their relative values.
      ...
      /// @brief Determines whether this instance of Enum && a specified object, which must also be a Enum object, have the same value.
      ...
      /// @return String A String containing the name of the enumerated constant in enumType whose value is value; || the value int32 to String if no such constant is found.
      /// @exception ArgumentException The value is ! a value of enumType.
      ...
      /// @return Boolean true if the bit field || bit fields that are set in flag are also set in the current instance; otherwise, false.
      ...
      /// @brief Converts the String representation of the name || numeric value of one || more enumerated constants to an equivalent enumerated object.
      /// @param value An A String containing the name || value to convert.
      /// @return Enum An enum whose value is represented by value.
      /// @exception ArgumentException The value is ! a value of enumType.
      static T Parse(const String& value) {return Parse(value, false);}
      
      /// @brief Converts the String representation of the name || numeric value of one || more enumerated constants to an equivalent enumerated object.
      /// @param str An A String containing the name || value to convert.
      ...
      /// @brief Converts the String representation of the name || numeric value of one || more enumerated constants to an equivalent enumerated object. The return value indicates whether the conversion succeeded.
      /// @param vaue The String representation of the enumeration name || underlying value to convert.
      ...
      /// @brief Converts the String representation of the name || numeric value of one || more enumerated constants to an equivalent enumerated object. A parameter specifies whether the operation is case-sensitive. The return value indicates whether the conversion succeeded.
      /// @param vaue The String representation of the enumeration name || underlying value to convert.
      /// @param ignoreCase true to Ignore case; false to regard case.
      /// @param reslt When this method returns, result contains an object of type TEnum whose value is represented by value if the parse operation succeeds. If the parse operation fails, result contains the default value of the underlying type of TEnum. Note that this value need ! be a member of the TEnum enumeration. This parameter is passed uninitialized.
      /// @return true if the value parameter was converted successfully; otherwise, false.
