...
int32 Socket::Accept(void* handle, byte* socketAddress, int32* addressLength, void** handleResult) {
  *handleResult = (void*)::accept(*(int32*)&handle, (SOCKADDR*)socketAddress, (int*)addressLength);

  if (*handleResult == (void*)-1)
    return -1;
...
int32 Socket::Open(System::Net::Sockets::AddressFamily addrFamily, System::Net::Sockets::SocketType socketType, System::Net::Sockets::ProtocolType protocolType, void** handle) {
  if (handle == null)
    return -1;

  *handle = (void*)::socket(AddressFamilyToNative(addrFamily), SocketTypeToNative(socketType), ProtocolTypeToNative(protocolType));
  if ((*handle) != (void*)-1)
    return 0;
...
int32 Socket::Poll(void* handle, int32 microSec, int32 mode) {
...
int32 Socket::ReceiveFrom(void* handle, byte* buffer, int32 bufferLength, int32 flags, byte *socketAddress, int32* addressLength) {
  return ::recvfrom(*(int32*)&handle, (char*)buffer, bufferLength, flags, reinterpret_cast<sockaddr*>(socketAddress), reinterpret_cast<int*>(addressLength));
}
...
int32 Socket::SendTo(void* handle, byte* buffer, int32 bufferLength, int32 flags, byte *socketAddress, int32 addressLength) {
  return ::sendto(*(int32*)&handle, (char*)buffer, bufferLength, flags, reinterpret_cast<sockaddr*>(socketAddress), addressLength);
}
