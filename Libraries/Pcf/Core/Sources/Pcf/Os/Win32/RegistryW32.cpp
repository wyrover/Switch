...
int32 Registry::NumberOfSubKey(void* hkey) {
...
int32 Registry::NumberOfValue(void* hkey) {
  LPSTR className = null;
  DWORD classNameSize = MAX_PATH;
  DWORD subKey = 0;
  DWORD maxSubKey;
...
/*
 ...
 DWORD  typeofvalue
 */
int32  Registry::EnumValues(void* hkey, int32 dwIndex, char *avaluename, char* val, int32 & typeofvalue, int32& sizekey, int32& sizeval) {
  int32 rcl = 0;
