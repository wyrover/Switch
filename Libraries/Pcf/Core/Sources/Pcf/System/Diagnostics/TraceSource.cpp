#include "../../../../Includes/Pcf/System/Diagnostics/TraceSource.h"
...
void TraceSource::TraceData(const TraceEventType& traceEventType, int32 id, const Array<SharedPointer<object>>& data) {
  TraceEventCache eventCache;
