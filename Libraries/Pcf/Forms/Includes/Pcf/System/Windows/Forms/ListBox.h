/// @file
/// @brief Contains Pcf::System::Windows::Forms::ListBox class.
#pragma once
      ...
      namespace Forms {
        ...
        public:
          ...
          public:
            ...
            ListBoxItemEventHandler ListBoxItemAdded;
          ...
          Property<int32> SelectedIndex {
            ...
            pcf_set {this->SetSelectedIndex(value);}
          };
          
          Property<SharedPointer<object>, ReadOnly> SelectedItem {
            pcf_get {return this->GetSelectedItem();}
          };

          Property<ObjectCollection&> Items {
            pcf_get->ObjectCollection& {return this->items;},
            [&](ObjectCollection& value) {this->Items = value;}
          };
        ...
        private:
          ...
          SharedPointer<object> GetSelectedItem() const;
          ...
          void OnListBoxItemAdded(const object& sender, const object& item);
