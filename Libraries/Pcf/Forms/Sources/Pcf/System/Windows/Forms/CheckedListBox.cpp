...
System::Windows::Forms::BorderStyle CheckedListBox::GetBorderStyle() const {
  static System::Collections::Generic::SortedDictionary<Fl_Boxtype, System::Windows::Forms::BorderStyle> borderSyles = {{FL_NO_BOX, System::Windows::Forms::BorderStyle::None}, {FL_FLAT_BOX, System::Windows::Forms::BorderStyle::None}, {FL_BORDER_BOX, System::Windows::Forms::BorderStyle::FixedSingle}, {FL_DOWN_BOX, System::Windows::Forms::BorderStyle::Fixed3D}};
...
void CheckedListBox::SetBorderStyle(System::Windows::Forms::BorderStyle borderStyle) {
  System::Collections::Generic::SortedDictionary<System::Windows::Forms::BorderStyle, Fl_Boxtype> borderSyles = {{System::Windows::Forms::BorderStyle::None, this->BackColor == System::Drawing::Color::Transparent ? FL_NO_BOX : FL_FLAT_BOX}, {System::Windows::Forms::BorderStyle::FixedSingle, FL_BORDER_BOX}, {System::Windows::Forms::BorderStyle::Fixed3D, FL_DOWN_BOX}};
