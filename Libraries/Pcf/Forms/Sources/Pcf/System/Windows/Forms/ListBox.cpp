...
System::Windows::Forms::BorderStyle ListBox::GetBorderStyle() const {
...
void ListBox::SetBorderStyle(System::Windows::Forms::BorderStyle borderStyle) {
  switch (borderStyle) {
    case System::Windows::Forms::BorderStyle::None: WidgetListBox::ToWidget(this->widget()).box(this->BackColor == System::Drawing::Color::Transparent ? FL_NO_BOX :  FL_FLAT_BOX); break;
    case System::Windows::Forms::BorderStyle::FixedSingle: WidgetListBox::ToWidget(this->widget()).box(FL_BORDER_BOX); break;
    case System::Windows::Forms::BorderStyle::Fixed3D: WidgetListBox::ToWidget(this->widget()).box(FL_DOWN_BOX); break;
  }
}
