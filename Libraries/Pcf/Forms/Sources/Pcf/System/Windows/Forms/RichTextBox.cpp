...
System::Windows::Forms::BorderStyle RichTextBox::GetBorderStyle() const {
...
void RichTextBox::SetBorderStyle(Pcf::System::Windows::Forms::BorderStyle borderStyle) {
  switch (borderStyle) {
    case System::Windows::Forms::BorderStyle::None: WidgetRichTextBox::ToWidget(this->widget()).box(this->transparent ? FL_NO_BOX : FL_FLAT_BOX); break;
    case System::Windows::Forms::BorderStyle::FixedSingle: WidgetRichTextBox::ToWidget(this->widget()).box(this->transparent ? FL_BORDER_FRAME : FL_BORDER_BOX); break;
    case System::Windows::Forms::BorderStyle::Fixed3D: WidgetRichTextBox::ToWidget(this->widget()).box(this->transparent ? FL_DOWN_FRAME : FL_DOWN_BOX); break;
  }
}
