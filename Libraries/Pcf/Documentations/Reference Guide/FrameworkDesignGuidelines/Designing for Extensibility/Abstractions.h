/// @page AbstractionsPage Abstractions (Abstract Types and Interfaces)
///
/// An abstraction is a type that describes a contract but does not provide a full implementation of the contract. Abstractions are usually implemented as abstract classes or interfaces, and they come with a well-defined set of reference documentation describing the required semantics of the types implementing the contract. Some of the most important abstractions in the Pcf include Stream, IEnumerable<T>, and Object.
///
...
///
/// <b>X DO NOT</b> provide abstractions unless they are tested by developing several concrete implementations and APIs consuming the abstractions.
///
/// <b>✓ DO</b> choose carefully between an abstract class and an interface when designing an abstraction.
///
/// <b>✓ CONSIDER</b> providing reference tests for concrete implementations of abstractions. Such tests should allow users to test whether their implementations correctly implement the contract.
///
