...
namespace PcfConsoleAppGenerator {
  ...
  public:
    ...
    static string GetProjectPathCMakeLists(const string& projectName) {
      return string::Format("include(Common NO_POLICY_SCOPE)\n"
                            ...
                            "set(SOURCES_FILES ./Sources/Program.cpp)\n"
                            "\n"
...
pcf_startup (PcfConsoleAppGenerator::Program)
