/// @page VirtualMembersPage Virtual Members
///
...
///
/// <b>X DO NOT</b> make members virtual unless you have a good reason to do so and you are aware of all the costs related to designing, testing, and maintaining virtual members.
///
...
///
/// <b>✓ CONSIDER</b> limiting extensibility to only what is absolutely necessary.
///
/// <b>✓ DO</b> prefer protected accessibility over public accessibility for virtual members. Public members should provide extensibility (if required) by calling into a protected virtual member.
///
